<nav x-data="{ open: false }" class="container z-20 mx-3 flex w-full flex-row justify-evenly">
    {{-- Logo  --}}
    ...
    {{-- Right Flexbox --}}
    <div class="lg: flex flex-row flex-wrap items-center justify-end space-x-4">
