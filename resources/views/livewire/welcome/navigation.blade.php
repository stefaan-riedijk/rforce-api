<nav class="-mx-3 flex justify-between w-full">
    <div class="flex justify-start">
        <a href="/">

            <svg class="mx-5 h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]" viewBox="0 0 62 65" fill="none"
    ...
    <div class="flex justify-evenly lg:gap-4">
        <a
            href="{{ url('/') }}"
